    ...
    <section class="text-gray-600 body-font" style="">
        <div class=" my-24 flex flex-col">
            <div class="ml-auto mr-auto">
                  <h1 style="font-size: 3em;" class="font-medium title-font mt-5 mb-2 text-gray-900 text-lg">About</h1>
                  <div class="w-12 h-1 bg-red-500 rounded mt-3 mb-11"></div>
                  </div>
                  <div class="sidebar">
                    <a class="sidebar-link" onclick="school()"><i class="bi">The School</i></a>
                    <a class="sidebar-link" onclick="vision()"><i class="bi">Vision and Mission</i></a>
                    <a class="sidebar-link" onclick="chairman()"><i class="bi">Chairman</i></a>
                    <a class="sidebar-link" onclick="principal()"><i class="bi">Principal</i></a>
                  ...
                  <div id="principal" style="box-shadow: 10px 0px 49px 1px rgba(0, 0, 0, 0.183); border-radius: 1em; background-color: rgba(255, 255, 255, 0.255);" class="my-14 container mx-auto flex px-5 py-14 md:flex-row flex-col items-center">
                    <div class="container mx-auto flex px-5 md:flex-row flex-col items-center">
                        ...
                        <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pr-16 flex flex-col md:items-start md:text-left items-center text-center">
                          ...
                          <h4 style="font-weight: 700; color: #d9232d;">Principal</h4><br>
                          <br>
                          <h4 style="font-weight: 600;">DEAR ALL</h4><br>
                          <p style="text-align: left;" class="mb-8 leading-relaxed">The core purpose of education is to provide children with a learning environment that brings out the best in them. We believe that every child is endowed with a unique set of attributes and abilities, which need to be nurtured so that they blossom. Therefore, every child deserves an education that fosters academic excellence and all-round development, and ensures their well-being. We are inspired by these tenets in everything that we do at Mahaveer International School.
...
document.getElementById("school").scrollIntoView(false);
    ...
    function vision() {
document.getElementById("vision").scrollIntoView(false);
    }
    function chairman() {
document.getElementById("chairman").scrollIntoView(false);
    }
    function principal() {
document.getElementById("principal").scrollIntoView(false);
    }
    function vice() {
document.getElementById("vice_principal").scrollIntoView(false);
    }
</script>