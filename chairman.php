...
<?php include "includes/header.php"; ?>
  ...
  <main id="main">
    ...
    <!-- ======= About Section ======= -->
    <section style="background-image: linear-gradient(rgba(255, 255, 255, 0.915), rgba(255, 255, 255, 0.859)), url(assets/img/school.jpg); margin-top: 10%;" id="about" class="about">
      <div style="text-align: center; " class="section-title features">
        <h2 style="font-size: 15px; margin-top: 2%; font-weight: 500;">Our</h2>
        <p>Chairperson</p>
        
      </div> 
      <div style="box-shadow: 10px 0px 49px 1px rgba(0, 0, 0, 0.183); border-radius: 1em; background-color: rgba(255, 255, 255, 0.255);" class="container">
